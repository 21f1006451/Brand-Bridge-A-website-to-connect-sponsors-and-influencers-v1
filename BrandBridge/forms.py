...
class AdRequestForm(FlaskForm):
    ...
    requirements = TextAreaField('Requirements', validators=[DataRequired()], render_kw={"placeholder": "Specify your requirements"}, default="No addtional requirements")
    payment_amount = IntegerField('Payment Amount (Rs.)', validators=[DataRequired()], render_kw={"placeholder": "Enter the amount in Rs."}, default="Your Budget")
